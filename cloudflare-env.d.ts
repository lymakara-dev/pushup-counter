/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: ced8e605026d1d34e2d81d2b021da12f)
// Runtime types generated with workerd@1.20260811.1 2026-08-14 global_fetch_strictly_public
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* pushup-counter */;
}
